...
<header>
    ...
    <div class="container-lg shadow-lg bg-dark text-light mt-1 p-3 rounded-3">
    ...
    <form method="POST">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="role" name="role">
                ...
                <option value="general_manager" <?php if ($employee['role'] == 'general_manager') echo 'selected'; ?>>مدير عام</option>
